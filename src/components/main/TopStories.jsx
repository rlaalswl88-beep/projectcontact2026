...
function TopStories() {
    ...
    return (
        <div className="do-main-home">
            ...
            <div className="top_menu_mobile_intro">
                <img
                    src={`${import.meta.env.BASE_URL}img/top/mobile_intro.jpg`}
                    alt="히어로콘텐츠"
                />
            </div>
            <div className="main_top">
                <div className="thumb_cont">
                    <Link to="/isolation/step1">
                        <div className="thumb top_visual_thumb">
                            <img
                                style={{
                                    width: '100%',
                                    height: '100%',
                    ...
                    <div className="do-hero-mobile-card" aria-hidden="true">
                        <span className="do-hero-mobile-card__tit">고립,그리고 연결</span>
                        <span className="do-hero-mobile-card__date">2026.04.24</span>
                    </div>
                </div>
                <div className="list_cont">
                    <ul className="thumb_list">
                        {topStories.map(({ tit, thumb, txt }) => (
                            <li key={tit}>
                                <a href="#" onClick={prevent}>
                                    <div className="thumb">
